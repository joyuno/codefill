#!/usr/bin/env python3
"""
배치 8: 인덱스 [1334, 1335, 1340, 1345, 1350, 1357, 1368, 1371, 1375, 1378]의
솔루션을 메인 파일에 직접 적용
"""
import json
...
"""
    ...
    # Index 1368: 합 (baekjoon_1132) - 그리디
    1368: [
        {
            "language": "python",
            "code": """import sys
...
"""
    ...
    # Index 1375: 분단의 슬픔 (baekjoon_13161) - 최소 컷
    1375: [
        {
            "language": "python",
            "code": """import sys
...
def main():
    ...
    for idx, solutions in solutions_data.items():
        if not data[idx].get('solutions'):
            data[idx]['solutions'] = solutions
            applied += 1
            print(f"Applied solutions to index {idx}: {data[idx]['name']}")

    # 저장
    with open(MAIN_FILE, 'w', encoding='utf-8') as f:
        json.dump(data, f, ensure_ascii=False, indent=2)

    print(f"\nTotal applied: {applied} problems")
