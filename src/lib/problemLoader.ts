...
import exampleProblems from '../../data/example_problem.json';
import blankProblems from '../../data/problems_blank.json';
import puzzleProblems from '../../data/problems_puzzle.json';
