...
**원본 솔루션 코드를 기반으로 개념/흐름/체크포인트를 생성하세요!**

- ❌ 원본과 다른 알고리즘 접근법 제시 금지
- ❌ 원본과 다른 자료구조 사용 금지
- ❌ 원본 코드를 "개선"하거나 "최적화"하는 내용 금지
- ❌ 원본에 없는 새로운 코드 패턴 제시 금지

**해야 할 것:**
- ✅ 원본 코드의 로직을 이해하고 설명하는 개념 생성
- ✅ 원본 코드의 흐름을 따라가는 단계 설계
- ✅ 원본 코드의 핵심 부분을 확인하는 체크포인트 생성

**예시:**
원본이 DP로 풀었다면 → DP 개념/흐름/체크포인트 생성
원본이 그리디로 풀었다면 → 그리디 개념/흐름/체크포인트 생성
(다른 접근법 제시 금지!)
